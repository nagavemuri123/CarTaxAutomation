...
public class BaseTest {
	...
	public static void initiateReporting(String browser) {
		htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir") + "\\Reports\\CartaxcheckTestReport_"
				+ new SimpleDateFormat("yyyyMMdd_HH_mm_ss").format(Calendar.getInstance().getTime()) + ".html");
